...
> [!info] Your volumes will be available in the /home/login/data folder of the host machine using Docker. Of course, you have to replace the login with yours.
...
--Docker network==================||                  ||
    ...
    -[ Container DB       ]------------- (DB)         ||
        ...
        | port 3305               ||                  ||
        |                         ||                  ||
    -[ Container Wordpress+PHP]----------(WordPress)  ||
        |                         ||         |        ||
        | port 9000               ||         |        ||
        |                         ||         |        ||
    -[ Container NGINX       ]---------------|        ||
